...
# diabetes = pd.read_csv('F:\\SZTU\\呼吸专科\\Code\\densenet121.csv')
diabetes = pd.read_excel('F:\SZTU\呼吸专科\Code\COPD\\test.xlsx')
...
plt.plot(fpr, tpr, '-', label='Densenet121 (AUC = {0:.2f})'.format(auc), lw=1)
